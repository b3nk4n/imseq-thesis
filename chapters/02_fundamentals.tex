...
% skip this? because we probably do not use it. Or just mention it's existence and why we do not use it --> only applicible to large images.
%Bla bla...
...
%%% Metrics (SSIM/MS-SSIM/PSNR/Sharp-Diff)
%%% Loss functions (GDL)
